...
function Solution() {
  return (
    ...
    <section className="tools">
        ...
        <div className="card">
                <h2>WebAccessify Accessibility Solution for WordPress</h2>
                <p>We provide a WordPress plugin for accessibility in WordPress websites. Our plugin makes websites more
                    accessible to everyone, including visitors with disabilities.</p>
                <div className="login-box">
                    <p1>Try Our WordPress Plugin for Free</p1>
                    <button>login</button>
                </div>
        </div>
    </section>
